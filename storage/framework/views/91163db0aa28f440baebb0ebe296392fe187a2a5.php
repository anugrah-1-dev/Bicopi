            ...
            <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel"
                ...
                <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                        <img src="<?php echo e(asset('image/' . $slider->image)); ?>" class="d-block w-100"
                            alt="Slide <?php echo e($index + 1); ?>">
                        <div class="carousel-container">
                            <h2><span><?php echo e($slider->title); ?></span></h2>
        ...
        <section id="about" class="about section light-background">
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
                        <img src="<?php echo e(asset('image/' . $about->image)); ?>" class="img-fluid" alt="">
                        <!-- Video link removed -->
                    </div>
                    <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="200">
                        <h3><?php echo e($about->judul); ?></h3>
                        <p class="fst-italic">
                            <?php echo e($about->subjudul); ?>

                        </p>
                        <ul>
                            <li><i class="bi bi-check2-all"></i> <span><?php echo e($about->kelebihan_1); ?></span></li>
                            <li><i class="bi bi-check2-all"></i> <span><?php echo e($about->kelebihan_2); ?></span></li>
                            <li><i class="bi bi-check2-all"></i> <span><?php echo e($about->kelebihan_3); ?></span></li>
                        </ul>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <section id="gallery" class="gallery section">
                ...
                <div class="container-fluid" data-aos="fade-up" data-aos-delay="100">
                    <div class="row g-0">
                        <?php $__currentLoopData = $portfolios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="gallery-item">
                                    <a href="<?php echo e(asset('image/' . $image->image)); ?>" class="glightbox"
                                        data-gallery="images-gallery">
                                        <img src="<?php echo e(asset('image/' . $image->image)); ?>" alt=""
            ...
            <div class="container isotope-layout" data-default-filter="*" data-layout="masonry"
                ...
                <div class="row isotope-container" data-aos="fade-up" data-aos-delay="200">
                    <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-lg-6 menu-item isotope-item <?php echo e($filterClass); ?>">
                            <div class="d-flex align-items-start">
                                <img src="<?php echo e(asset('image/' . $menu->foto_menu)); ?>" class="menu-img" alt="<?php echo e($menu->nama_menu); ?>">

                                <div>
                                    <div class="menu-content d-flex justify-content-between">
                                        <a href="#"><?php echo e($menu->nama_menu); ?></a>
                                        <span>Rp <?php echo e(number_format($menu->harga_menu, 0, ',', '.')); ?></span>
                                    </div>
                                    <div class="menu-ingredients">
                                        <?php echo e($menu->deskripsi_menu); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 mt-4 mt-lg-0">
                        <div class="tab-content">
                            <?php $__currentLoopData = $specials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $special): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="tab-pane <?php echo e($index == 0 ? 'active show' : ''); ?>"
                                    id="specials-tab-<?php echo e($index + 1); ?>">
                                    <div class="row">
                                        <div class="col-lg-8 details order-2 order-lg-1">
                                            <h3><?php echo e($special->judul); ?></h3>
                                            <p class="fst-italic"><?php echo e($special->deskripsi); ?></p>
                                        </div>
                                        <div class="col-lg-4 text-center order-1 order-lg-2">
                                            <img src="<?php echo e(asset('image/' . $special->image)); ?>" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
              ...
              "pagination": {
                ...
                "clickable": true
                    ...
                    <div class="swiper-wrapper">
                        <?php $__currentLoopData = $promosi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="swiper-slide">
                                <div class="row gy-4 event-item">
                                    <!-- ...existing code... -->
<div class="col-lg-6">
    <img src="<?php echo e(asset('image/' . $item->image)); ?>" class="img-fluid event-img-custom" alt="">
</div>
<!-- ...existing code... -->
                                    <div class="col-lg-6 pt-4 pt-lg-0 content">
                                        <h3><?php echo e($item->judul); ?></h3>
                                        <p class="fst-italic">
                                            <?php echo e($item->deskripsi_1); ?>

                                        </p>
                                        <ul>
                                            <li><i class="bi bi-check2-circle" style="color: #059652;"></i>
                                                <span><?php echo e($item->kelebihan_1); ?></span>
                                            </li>
                                            <li><i class="bi bi-check2-circle" style="color: #059652;"></i>
                                                <span><?php echo e($item->kelebihan_2); ?></span>
                                            </li>
                                            <li><i class="bi bi-check2-circle" style="color: #059652;"></i>
                                                <span><?php echo e($item->kelebihan_3); ?></span>
                                            </li>
                                        </ul>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-md-6 d-flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0"><?php echo e($contact->alamat); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-flex gap-3">
                            ...
                            <div>
                                ...
                                <?php if($contact->telepon): ?>
                                <p class="mb-0"><?php echo e($contact->telepon); ?></p>
                                <?php endif; ?>
                                <?php if($contact->telepon_2): ?>
                                <p class="mb-0"><?php echo e($contact->telepon_2); ?></p>
                                <?php endif; ?>
                                <?php if($contact->email): ?>
                                <p class="mb-0"><?php echo e($contact->email); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0"><?php echo e($contact->jam_buka ?: 'Senin - Minggu'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-flex gap-3">
                            ...
                            <div>
                                ...
                                <div class="social-links d-flex gap-2 mt-1">
                                    ...
                                    <a href="<?php echo e($contact->twitter); ?>" class="twitter"><i class="bi bi-twitter-x"></i></a>
                                    <?php endif; ?>
                                    <?php if($contact->facebook): ?>
                                    <a href="<?php echo e($contact->facebook); ?>" class="facebook"><i class="bi bi-facebook"></i></a>
                                    <?php endif; ?>
                                    <?php if($contact->instagram): ?>
                                    <a href="<?php echo e($contact->instagram); ?>" class="instagram"><i class="bi bi-instagram"></i></a>
                                    <?php endif; ?>
                                    <?php if($contact->lynkin): ?>
                                    <a href="<?php echo e($contact->lynkin); ?>" class="linkedin"><i class="bi bi-linkedin"></i></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH D:\Projek_Web\laragon\www\Website Bicopi\resources\views/home/index.blade.php ENDPATH**/ ?>
...
<head>
  ...
  <title>@yield('title', 'Bicopy Admin')</title> <!-- Default title jika tidak ada title yang di-set -->

  <!-- Favicon -->
  <link rel="icon" href="{{ asset('logo.png') }}" type="image/x-icon"> <!-- Menambahkan favicon -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/admin/dashboard" class="brand-link">
      <img src="{{ asset('assets/img/logo_bikopi.jpg') }}" alt="logo" class="brand-image img-circle elevation-3" style="opacity: .8">

        ...
        <div class="col-md-12">
            <form action="{{ route('menu.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="harga_menu" placeholder="Nama Menu">
                </div>
                @error('harga_menu')
                <small style="color:red">{{$message}}</small>
                @enderror
                <div class="form-group">
                    ...
                    <textarea name="deskripsi_menu" id="" cols="30" rows="10" class="form-control" placeholder="Deskripsi Menu"></textarea>
                </div>
